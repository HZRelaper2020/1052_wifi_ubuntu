...
XIP_LOAD_ADDRESS             := $(XIP_OCF_START_ADDR)
endif #ifeq (1,$(OTA2_SUPPORT))

SFLASH_BASE_ADDRESS			 := $(OTA2_IMAGE_FLASH_BASE_ADDRESS)
#Link start address = $(SFLASH_BASE_ADDRESS) + $(XIP_LOAD_ADDRESS)
XIP_LINK_START_ADDRESS       = $(shell $(PERL) -le 'print sprintf("0x%X", $(SFLASH_BASE_ADDRESS) + $(XIP_LOAD_ADDRESS))')

XIP_REGION_LENGTH			 := $(XIP_OCF_MAX_SIZE)
