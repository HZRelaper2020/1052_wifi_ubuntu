...
OTA2_IMAGE_CURR_OTA_APP_AREA_BASE    := 0x00225000	# 308k 0x0004D000 was 300k, For SECURE_SFLASH 316K 0x0004F000

# File system (start on 4k boundary)
ifeq (1, $(SECURE_SFLASH))
OTA2_IMAGE_CURR_FS_AREA_BASE         := 0x00274000	# 852k  0x000D5000
else
OTA2_IMAGE_CURR_FS_AREA_BASE         := 0x00272000	# 860k  0x000D7000
endif

#App0 - Application (start on 4k boundary)
#In non-XIP case, the space of APP0 , 0x0349000 - 0x00600000 is 2.714M(0x002B7000).
#For XIP case the 2.714M space is shared with APP0_XIP binary.
#Currently APP0_XIP base is set to 0x400000. It can be adjusted according to use case.
OTA2_IMAGE_CURR_APP0_AREA_BASE       := 0x00349000
ifeq (1, $(XIP_SUPPORT))
