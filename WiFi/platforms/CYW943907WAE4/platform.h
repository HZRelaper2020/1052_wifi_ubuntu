...
/*
BCM943907WAE4 platform pin definitions ...
+-------------------------------------------------------------------------------------------------------------------+
| Enum ID       |Pin  |   Pin Name on    |  Module                           |  Conn  |  Peripheral  |  Peripheral  |
|               | #   |   43907WAE4      |  Alias                            |  Pin   |  Available   |    Alias     |
|---------------+-----+------------------+-----------------------------------+--------+--------------+--------------|
...
#define WICED_PLATFORM_BUTTON_COUNT      ( 5 )       /* NOTE: actually 5, Multi is Down */

#define WICED_PLATFORM_INCLUDES_SPI_FRAM
#define WICED_SPI_FLASH_PORT (BCM4390X_SPI_0)
#define WICED_SPI_FLASH_CS   (WICED_GPIO_22)

/* Components connected to external I/Os*/
#define PLATFORM_LED_COUNT               ( 1 )       /* PWM_4 - PWM Led */
#define WICED_LED1       (WICED_GPIO_17)
#define WICED_LED2       (WICED_GPIO_17)             /* NOTE: overload LED1 to allow apps/snip/gpio build */
...
#define WICED_GPIO_AKM_PDN                      (WICED_GPIO_16)
...
#define WICED_BUTTON_MULTI_FUNC         ( WICED_GPIO_1 )    /* NOTE: Removed on WAE4 - mapped to down */
#define WICED_BUTTON_PAUSE_PLAY         ( WICED_GPIO_7)     /* NOTE: Changed from MISO for access to SPI */
#define WICED_BUTTON_VOLUME_UP          ( WICED_GPIO_5 )    /* x */
#define WICED_BUTTON_VOLUME_DOWN        ( WICED_GPIO_1 )    /* NOTE: Also mapped to Multi */
#define WICED_BUTTON_BACK               ( WICED_GPIO_18)    /* x */
#define WICED_BUTTON_FORWARD            ( WICED_GPIO_3 )    /* x */
