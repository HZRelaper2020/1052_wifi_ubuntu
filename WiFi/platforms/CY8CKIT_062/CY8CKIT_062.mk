...
NAME := Platform_CY8CKIT_062

WLAN_CHIP            := 4343W
WLAN_CHIP_REVISION   := A1
WLAN_CHIP_FAMILY     := 4343x
HOST_MCU_FAMILY      := PSoC6
HOST_MCU_VARIANT     := cy8c6x7
HOST_MCU_PART_FAMILY := psoc62
HOST_MCU_PART_NUMBER := cy8c6247bzi_d54
BT_CHIP              := 43438
BT_CHIP_REVISION     := A1
...
# Some flags needs to be removed when the functionality is implemented
# Global defines.
...
# FR_APP := resources/sflash/snip_ota_fr-<platform>.stripped.elf
# DCT_IMAGE :=
# OTA_APP :=
# FILESYSTEM_IMAGE :=
# WIFI_FIRMWARE :=
