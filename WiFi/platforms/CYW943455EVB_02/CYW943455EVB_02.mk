...
NAME := Platform_CYW943455EVB_02

WLAN_CHIP            := 43455
WLAN_CHIP_REVISION   := C0
WLAN_CHIP_FAMILY     := 43455
HOST_MCU_FAMILY      := STM32H7xx
HOST_MCU_VARIANT     := STM32H753
HOST_MCU_PART_NUMBER := STM32H753VIT6
BT_CHIP              := 43455
BT_CHIP_REVISION     := C0
BT_MODE              ?= HCI
...
GLOBAL_DEFINES += WLAN_ARM_CR4

# Components
$(NAME)_COMPONENTS += inputs/gpio_button

# Source files
$(NAME)_SOURCES  := ../evaluation_boards/CYW9WLWCDEVAL1/platform.c
GLOBAL_INCLUDES  += ../evaluation_boards/CYW9WLWCDEVAL1/
